...
function EinTagMitLenaSection() {
  const szenen = [
    { time: 'Früher — ohne Assistent', spoken: null, image: '/pitch/12-old-day.png', alt: 'Unternehmer überfordert am Schreibtisch, Papierchaos', result: '47 ungelesene Mails. Drei davon dringend — aber welche? Termine, die du fast vergisst, Rückfragen vom Team. Schon vor dem ersten Kaffee hinterher. So sah dein Morgen bisher aus.' },
    { time: '06:30 — Aufwachen', spoken: null, image: '/pitch/01-morning.png', alt: 'Unternehmer wacht entspannt auf, liest Briefing am Handy', result: 'Statt Chaos: ein Briefing. Umsatz gestern, was über Nacht reinkam, deine Termine, was heute wichtig ist. 90 Sekunden lesen — du weißt, woran du bist, bevor der Tag dich kriegt.' },
    { time: '07:00 — Kaffee & Freigaben', spoken: null, image: '/pitch/02-coffee.png', alt: 'Unternehmer gibt am Handy Aufgaben frei', result: 'Drei Freigaben warten: Bestellung ✅, Antwort an einen Kunden ✏️ noch persönlicher, Hotel für nächste Woche ✅. Drei Sekunden pro Entscheidung. Du entscheidest — dein Assistent macht den Rest.',
    ...
    /* TODO Memory-Szenen: brauchen 2 EIGENE Bilder (Sprachnotiz + Kundenhistorie),
       aktuell ausgeblendet weil kein passendes Bild da war (waren Duplikate von
       coffee/postcall). Sobald die 2 Bilder generiert sind: image-Pfad setzen +
       wieder einkommentieren. Texte hier erhalten.
    { time: '07:45 — Vor dem Aufbruch', spoken: 'Schmidt mag direkte Mails, kein Geschwafel — und sein neuer Einkäufer heißt Bernhardt, kommt aus dem Banken-Sektor.', image: '/pitch/TODO-sprachnotiz.png', alt: 'Unternehmer spricht Sprachnotiz ins Handy', result: 'Du sprichst es einfach ins Handy, drei Sekunden. Für immer gespeichert. Dein Assistent lernt dich und deine Kunden kennen — wie ein Mitarbeiter, der nie vergisst.' },
    { time: '6 Monate später', spoken: null, image: '/pitch/TODO-historie.png', alt: 'Unternehmer sieht erfreut die zusammengezogene Kundenhistorie', result: 'Eine Mail von Schmidt kommt rein. Dein Assistent zieht alles zusammen: Historie, Tonfall-Hinweise, deine Notizen. Du antwortest in der Sprache, die dein Kunde mag — ohne nachzudenken.' },
    */
    { time: '08:10 — Eine Beschwerde kommt rein', spoken: 'Sag Herrn Brandt, dass es mir leid tut — und dass wir uns gerne auf einen Kaffee zusammensetzen, um das aus der Welt zu schaffen.', image: '/pitch/13-angebot.png', alt: 'Unternehmer am Schreibtisch diktiert eine Antwort ins Handy', result: 'Eine verärgerte Mail landet im Posteingang — dein Assistent erkennt: Beschwerde, hoch priorisiert, und legt sie dir oben hin. Du sagst in einem Satz, was passieren soll. Sekunden später liegt die fertige, höfliche Mail bereit. Du liest, drückst Approve — raus. Aus einem Stoßseufzer wird eine professionelle Antwort.',
      discord: [
    ...
    { time: '08:30 — Im Auto', spoken: 'Brief mich nochmal zum Termin Schmidt GmbH.', image: '/pitch/03-car.png', alt: 'Unternehmer fährt Auto, hört Briefing', result: 'Während du fährst, liest dir dein Assistent das Wichtigste vor: wer im Termin sitzt, was zuletzt besprochen wurde, frische News zur Firma. Du kommst vorbereitet an.' },
    { time: '09:43 — Nach dem Termin', spoken: null, image: '/pitch/04-postcall.png', alt: 'Unternehmer zufrieden nach dem Meeting am Schreibtisch', result: 'Audio in den Channel. Drei Minuten später: Action-Items, Insights, Risiken — strukturiert. Du schickst direkt das Follow-up raus, ohne eine Notiz abzutippen.' },
    { time: '11:15 — Team-Frage', spoken: null, image: '/pitch/14-team.png', alt: 'Unternehmer geht entspannt durchs Büro', result: '„Wie war nochmal der Ablauf für die Reisekostenabrechnung?" Früher unterbricht dich das. Jetzt antwortet dein Assistent aus dem Firmen-Wissen — die Antwort, die DU mal hinterlegt hast. Du wirst nur bei echtem Neuland gefragt.' },
    { time: '14:30 — Beim Geschäftsessen', spoken: null, image: '/pitch/15-beleg.png', alt: 'Unternehmer fotografiert Beleg im Café', result: 'Bewirtungsbeleg abfotografiert, fertig. Datum, Betrag, Kategorie, Lieferant — alles ausgelesen und sortiert abgelegt. Was dein Steuerberater braucht, ist immer bereit. Keine Zettel im Handschuhfach.',
    ...
    { time: '18:00 — Feierabend', spoken: null, image: '/pitch/07-evening.png', alt: 'Unternehmer entspannt abends auf dem Sofa', result: 'Du klappst den Laptop zu. Im Briefing wartet dein Tages-Wrap: alles erledigt, alles dokumentiert, Morgen-Plan steht schon. Du kannst loslassen — der Assistent hat den Faden.' },
  ];
  return (
