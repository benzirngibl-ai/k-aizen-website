  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .kbot-monk-top {
        ...
        margin-top: 35px;     /* Lena 35px tiefer im Layout-Slot */
      }
  ...
  function renderWidget() {
    ...
    root.innerHTML = `
      <div class="kbot-handle" id="kbot-handle" role="button" tabindex="0" aria-label="Chat öffnen">
        <img class="kbot-bubble kbot-bubble-welcome" src="/widgets/bubble-welcome.png?v=20260528-younglena-v4" alt="" />
        <img class="kbot-bubble kbot-bubble-help" src="/widgets/bubble-help.png?v=20260528-younglena-v4" alt="" />
